...
const styles = StyleSheet.create({
    ...
    avatarCircle: {
        ...
        backgroundColor: COLORS.ecoBlue + '14',
    ...
    roleBadge: {
        ...
        borderRadius: BORDER_RADIUS.sm, backgroundColor: COLORS.ecoBlue + '1A',
        borderWidth: 1, borderColor: COLORS.ecoBlue + '40',
    },
    roleText: { color: COLORS.brandBlue, fontSize: 11, fontWeight: '700', letterSpacing: 0.5 },
    ...
    subLabel: { ...TYPOGRAPHY.label, fontSize: 10, fontWeight: '700', marginBottom: SPACING.sm },
    relationRow: { flexDirection: 'row', flexWrap: 'wrap', marginBottom: SPACING.xl },
    relationPill: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: COLORS.divider, marginRight: SPACING.sm, marginBottom: SPACING.sm },
